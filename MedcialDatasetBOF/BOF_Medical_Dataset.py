...
def process_with_crop(dataset="MONU"):
    ...
    for crop_size in crop_list:
        ...
        temp_image_processor = ISICBOF(costume_transform=costume_transform, save_file_path=save_pkl_path, repetitions=10, imgpath=f"../../others_work/dataset/{dataset}/train_folder")
        # 跳出循环
        # break
...
def process_with_angle(dataset="MONU"):
    ...
    for max_angle in min_angle_list:
        ...
        temp_image_processor = ISICBOF(costume_transform=None, save_file_path=save_pkl_path, repetitions=10, imgpath=f"../../others_work/dataset/{dataset}/train_folder")
        # 跳出循环
        # break
