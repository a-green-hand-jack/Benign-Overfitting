...
class ImageProcessor:
    def __init__(self, costume_transform, cifar_path='./data', save_file_path=None, repetitions=1, img_num=5000):
    ...
    def images_to_matrix_lists(self):
        ...
        # 创建一个包含随机选取样本的子数据集
        indices = np.random.choice(len(trainset), self.img_num, replace=False)  # 随机选取 5000 个索引
