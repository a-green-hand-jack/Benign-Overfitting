...
angle_path = "./test_rescale_1207/angle_torch"
i = 1
min_png = 6
min_pkl = 1
...
for max_angle in min_angle_list:
    ...
    MLP_no_aug = ModelWithOneAugmentation(model=MLP(), net_name="MLP", transform=data_transform, augmentation_name="angle", num_repeats=2, num_epochs=300,save_path=save_floor, train_model=False, torch_aug=False)
