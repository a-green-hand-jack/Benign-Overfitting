...
from TDA.get_betti_number import check_folder_integrity
...
def count_epsilon_bar_number(matrix):
    max_cont = 0
    max_epsilon = 0

    min_first_colum, max_second_column , _= get_min_max_columns(matrix)
    min_first_colum, max_second_column = int(min_first_colum), int(max_second_column)
