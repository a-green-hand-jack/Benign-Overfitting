...
for max_angle in min_angle_list:
    ...
    model_LeNet = LeNet()
    LeNet_path = f"{angle_path}/LeNet/{max_angle}"
    ...
    model_MLP = MLP()
    MLP_path = f"{angle_path}/MLP/{max_angle}"
    ...
    ResNet18_path = f"{angle_path}/ResNet18/{max_angle}"
    ...
    ResNet34_path = f"{angle_path}/ResNet34/{max_angle}"
    ...
    ResNet50_path = f"{angle_path}/ResNet50/{max_angle}"
    ...
    ResNet101_path = f"{angle_path}/ResNet101/{max_angle}"
    ...
    ResNet152_path = f"{angle_path}/ResNet152/{max_angle}"
