...
class ImageNetTDA:
    def __init__(self, costume_transform, cifar_path='./data', save_file_path=None, repetitions=1, model=None,device=torch.device("cuda" if torch.cuda.is_available() else "cpu"), betti_dim = 1, care_layer = -2):
